...
@section('title', 'Edit Wallet - Money Manager')
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">Edit Wallet</h4>
                    <ol class="breadcrumb">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card m-b-20">
                        <div class="card-body">
                            <form action="{{ route('wallet.update', $wallet['data']['id']) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Nama Wallet</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" placeholder="Input nama wallet" name="name_wallet" value="{{ $wallet['data']['name_wallet'] }}" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Saldo</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" type="number" placeholder="Input saldo awal" name="balance" value="{{ $wallet['data']['balance'] }}" required=''>
                                    </div>
                                </div>
